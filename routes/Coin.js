        ...
        <div className='content'>
          <table>
            <thead>
              ...
              <tbody>
                <tr>
                  <td>{coin.market_data?.price_change_percentage_1hr_in_currency ? <p>{coin.market_data.price_change_percentage_1hr_in_currency.usd.toFixed(1)}%</p> : null}</td>

                  <td>{coin.market_data?.price_change_percentage_24hr_in_currency ? <p>{coin.market_data.price_change_percentage_24hr_in_currency.usd.toFixed(1)}%</p> : null}</td>
        ...
        <div className='content'>
          <div className='stats'>
            <div className='left'>
              <div className='row'>
              <h4> 24 Hour Low </h4>
                    {coin.market_data?.low_24hr ? <p>${coin.market_data.low_24hr.usd.toLocaleString()}</p> : null}
              </div>
              <div className='row'>
              <h4>24 Hour High</h4>
              {coin.market_data?.high_24hr ? <p>${coin.market_data.high_24hr.usd.toLocaleString()}</p> : null}
              </div>  
